...
function kiemTraDiem() {
   ...
   let diemTongKet = diemMon1 + diemMon2 + diemMon3 + diemKhuVuc + diemDoiTuong;
    ...
    if (diemTongKet >= diemChuan) {
        console.log("Đậu với điểm tổng kết là ${diemTongKet}")
    } else {
        console.log("Rớt")
    }

    document.getElementById("ketQua").innerHTML = '${hienThiKetQua}'
}
...
function tinhTienDien() {
    ...
    document.getElementById("ketQua2").innerHTML = "Tên khách hàng: " + ten +"<br>Số tiền phải trả: " + tien.toLocaleString() + "đ";
}
...
function tinhTienCap() {
    ...
    document.getElementById("ketQua4").innerHTML = "<h3>Hóa Đơn Cáp</h3>" +
